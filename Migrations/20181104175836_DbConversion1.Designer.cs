...
namespace HeritageApp.Migrations
{
    ...
    [Migration("20181104175836_DbConversion1")]
    partial class DbConversion1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeritageApp.Models.Database.EvaluationParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("EvaluationParameters");
                });
            ...
            modelBuilder.Entity("HeritageApp.Models.Database.HeritageActivationMode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("HeritageActivationModes");
                });
            ...
            modelBuilder.Entity("HeritageApp.Models.Database.HeritageActivationMode", b =>
                {
                    ...
                    b.HasOne("HeritageApp.Models.Database.Heritage")
                        .WithMany("HeritageActivationModes")
                        .HasForeignKey("HeritageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
