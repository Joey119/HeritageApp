...
namespace HeritageApp.Helpers {
    public class AutoMapperProfile : Profile {
        public AutoMapperProfile () {
            ...
            CreateMap<EvaluationParameter, EvaluationParameterDto> ();
            CreateMap<EvaluationParameterDto, EvaluationParameter> ();

            CreateMap<HeritageActivationMode, HeritageActivationModeDto> ();
            CreateMap<HeritageActivationModeDto, HeritageActivationMode> ();
            ...
            CreateMap<HeritageDto, Heritage> ()
                ...
                .ForMember (dest => dest.HeritageActivationModes, opt => opt.Ignore ());
